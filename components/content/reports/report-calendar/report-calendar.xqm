      ...
      return
        (
          ...
          <td>
            ...
            (начало: { $j/cell[ @label = 'Время начала' ]/text() }, продолжительность: { $j/cell[ @label = 'Длительность' ]/text() }, форма: { $j/cell[ @label = 'Форма']/text() }, категория: { $j/cell[ @label = 'Категория мероприятия' ]/text() }, инициатор: { $j/cell[ @label = 'Инициатор' ]/text() })
          </td>,
          <td>{
